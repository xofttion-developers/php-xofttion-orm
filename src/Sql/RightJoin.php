...
class RightJoin implements IClause
{

    // Atributos de la clase RightJoin
    ...
    // Constructor de la clase RightJoin
    ...
    {
        $builder->rightJoin($this->getRelation(), $this->getParentColumn(), $this->getOperator(), $this->getRelationColumn());
    }
}
