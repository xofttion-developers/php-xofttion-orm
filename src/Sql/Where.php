...
class Where implements IWhere
{
    ...
    {
        $this->predicates[] =  new Condition($column, $operator, $value, $or);
    ...
    {
        $this->predicates[] =  new In($column, $value, $or, $not);
    ...
    {
        $this->predicates[] =  new Between($column, $value, $or, $not);
    ...
    {
        $this->predicates[] =  new Like($column, $value, $or, $not);
    ...
    {
        $this->predicates[] =  new IsNull($column, $or, $not);
    ...
    {
        $this->predicates[] =  new Raw($sentence);
