...
class LeftJoin implements IClause
{

    // Atributos de la clase LeftJoin
    ...
    // Constructor de la clase LeftJoin
    ...
    {
        $builder->leftJoin($this->getRelation(), $this->getParentColumn(), $this->getOperator(), $this->getRelationColumn());
    }
}
