...
use Xofttion\ORM\DAL\Contracts\IStorage;
...
class Storage implements IStorage {
    ...
    public function insert(IModel $model, ?array $hidrations = null): IModel {
        $model->save(); return $model->fresh($hidrations);
    }
    ...
    protected function getQuery(): IQuery {
        $query = new Query($this->model); // Iniciando
        
        $query->setContext($this->getContext());
        
        return $query; // Retornando query del modelo
    }
}